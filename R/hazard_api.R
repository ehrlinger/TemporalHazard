...
#'   evaluation point the measure did not see -- a zero entry time, or a bound
#'   equal to the event time, adds nothing -- since it is measured over the
#'   event times alone. For the same reason the per-phase measures can
