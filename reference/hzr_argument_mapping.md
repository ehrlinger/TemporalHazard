...
[`hzr_decompos()`](https://ehrlinger.github.io/TemporalHazard/reference/hzr_decompos.md)/[`hzr_decompos_g3()`](https://ehrlinger.github.io/TemporalHazard/reference/hzr_decompos_g3.md)
...
#> 17             (not implemented)    FALSE               numeric scalar
...
#> 17 time transform B(t) = (exp(delta*t)-1)/delta; drops out at DELTA = 0, non-zero DELTA not implemented
...
#> 16            G2          G2 constant phase  constant hazard rate phase
#> 17            G3                 TAU (late)               late G3 scale
#> 18            G3               GAMMA (late)       late G3 time exponent
#> 19            G3               ALPHA (late)               late G3 shape
#> 20            G3                 ETA (late)      late G3 outer exponent
#>                      r_parameter required                expected_type
#> 1                           time     TRUE               numeric vector
#> 2                         status     TRUE       numeric/logical vector
#> 3                              x    FALSE numeric matrix or data.frame
...
#> 16         hzr_phase('constant')    FALSE        hzr_phase('constant')
#> 17         hzr_phase('g3', tau=)    FALSE              positive scalar
#> 18       hzr_phase('g3', gamma=)    FALSE               numeric scalar
#> 19       hzr_phase('g3', alpha=)    FALSE               numeric scalar
#> 20         hzr_phase('g3', eta=)    FALSE               numeric scalar
#>                                                                                transform_rule
#> 1                                                                     pass through as numeric
#> 2                                                                       coerce to numeric 0/1
#> 3                                                                   data.frame -> data.matrix
...
#> 16                                             hzr_phase('constant') with no shape parameters
#> 17                                      maps directly to hzr_phase('g3', tau=) for late phase
#> 18                                    maps directly to hzr_phase('g3', gamma=) for late phase
#> 19                                    maps directly to hzr_phase('g3', alpha=) for late phase
#> 20                                      maps directly to hzr_phase('g3', eta=) for late phase
#>    implementation_status
#> 1            implemented
#> 2            implemented
#> 3            implemented
...
#> 16                                  Flat background rate. No shape parameters estimated. SAS G2 equivalent.
#> 17                                   Late-phase G3 scale parameter. Maps directly to hzr_phase('g3', tau=).
#> 18                                   Late-phase G3 time exponent. Maps directly to hzr_phase('g3', gamma=).
#> 19 Late-phase G3 shape parameter. alpha=0 gives exponential case. Maps directly to hzr_phase('g3', alpha=).
#> 20                                    Late-phase G3 outer exponent. Maps directly to hzr_phase('g3', eta=).
```
